  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: 'The teacher account has been created successfully.',
        confirmButtonColor: '#696cff'
      }).then(() => navigate('/dashboard/users/teachers'));
      ...
      Swal.fire({
        ...
        text: err.response?.data?.message || 'Unable to create teacher account. Please try again.',
        confirmButtonColor: '#696cff'
      });
    } finally {
      setSubmitting(false);
    ...
    <div className="container-xxl container-p-y">
      <nav aria-label="breadcrumb" className="mb-4">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item">
            <a href="/dashboard/users/teachers" className="text-decoration-none">Teachers</a>
          </li>
          <li className="breadcrumb-item active" aria-current="page">Create Teacher</li>
        </ol>
      </nav>

      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h4 className="fw-bold mb-1">Create Teacher</h4>
          <p className="text-muted mb-0">Add a new teacher account to the system</p>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit}>
                    ...
                    <div className="row g-3">
                      {isSuperAdmin && (
                        <div className="col-md-6">
                          ...
                          <div className="form-text">Choose which organization this teacher will belong to</div>
                        </div>
                      )}
                      ...
                      {showProgram && (
                        <div className="col-md-6">
                          ...
                          <div className="form-text">Select the program for this teacher</div>
                        </div>
                      )}
                      ...
                      {showBatch && (
                        <div className="col-md-6">
                          ...
                          <div className="form-text">Select the batch for this teacher</div>
                        </div>
                      )}
                ...
                <div className="border-top pt-4 mt-4">
                  ...
                  <p className="text-muted small mt-3 mb-0">
                    <TablerIcons.IconInfoCircle size={16} className="me-1" />
                    The teacher will receive login credentials via email
                  </p>
                </div>
